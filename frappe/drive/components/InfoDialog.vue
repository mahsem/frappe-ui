  ...
  <Dialog v-model="open" @close="dialogType = ''">
    ...
    <template #body-content>
      ...
      <ul v-if="developer" class="space-y-3 text-sm text-ink-gray-8 mb-4 mt-4">
        ...
        <li>
          <span class="inline-block w-24">File type:</span>
          <span class="col-span-1">{{ entity.file_type }}</span>
        </li>
      </ul>
    </template>
...
<script setup>
import { Dialog, Button, LoadingIndicator, createResource } from '../../../src'
...
const props = defineProps({ entity: Object, emitter: Object })
